...
Le déploiement du `service-erp` (basé sur le framework Idurar) ! Il s'agit du **système nerveux central financier** de Prestige Maroc. Il gère la comptabilité, automatise la création des PDF légaux, et trace chaque Dirham (MAD) qui entre ou sort de l'agence.
...
### 📝 Page : Quotes / Offers (Devis / Factures Proforma)
...
- **Le Contenu (Détail) :** L'enregistrement de toutes les sorties d'argent avec pièces jointes (scan de reçu).
...
### 📦 Page : Products (Produits / Inventaire)
- **De quoi s'agit-il :** La liste des "produits" ou "services" vendus.
- **Le Contenu (Détail) :** Dans le cas d'une agence de location, on y met "Location Citadine / Jour", "Option Siège Bébé", "Frais Kilométriques".
- **Le Problème Résolu :** Évite de devoir tout retaper à chaque facture. Les prix de base sont enregistrés.

### ⚙️ Page : Settings / Company Profile (Paramètres)
- **De quoi s'agit-il :** Les réglages de l'entreprise.
- **Le Contenu (Détail) :** C'est ici que l'administrateur renseigne l'adresse de l'agence, l'ICE, le numéro de compte bancaire pour que tout s'imprime automatiquement sur les factures.
